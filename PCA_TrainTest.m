function [E, E_train] = PCA_TrainTest(Data, size_train,length_window,varargin)
% PCA - Test and Train
...
optargs = {'PC' false 99 'Plot' false 'Missing title' false};
...
W_train = clean_data(:,1:num_train_w*length_window);
W_test  = clean_data(:,num_train_w*length_window+1:end);
...
num_prin = 1;
while sum(explained(1:num_prin)) < PC_num
    num_prin = num_prin + 1;
end 
